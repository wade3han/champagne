...
# from t5x.examples.unified_io.dumy_exec import DummyExecutor
...
def evaluate(
  ...
  evaluator = UnifiedIOEvaluator(
      ...
      target_field_name=dataset_cfg.target_field_name,
  ...
  # evaluator._metrics_executor = DummyExecutor()
  ...
  states = list(train_state_initializer.from_checkpoints(
